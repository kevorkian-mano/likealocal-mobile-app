...
class DatabaseSeeder {
  static final FirebaseFirestore _db = FirebaseFirestore.instanceFor(app: Firebase.app(), databaseId: 'default');
    ...
    for (var u in usersToSeed) {
      try {
        ...
        if (e is FirebaseAuthException && e.code == 'email-already-in-use') {
          ...
          throw e; // Rethrow to halt if unexpected
        }
      }
    }
  ...
  static Future<void> _seedUsers() async {
    ...
    if (existing.docs.isNotEmpty) { print('ℹ️  Users already seeded.'); return; }
    ...
    final users = [
      {
        ...
        'bio': 'P24 | City explorer & food photographer. I find the places Google Maps never will.',
        'selectedVibes': ['Hidden Cafes', 'Street Food', 'Art & Design', 'Rooftops'],
        'karmaPoints': 850,
        'isSuperUser': true,
        'isAdmin': true,
        'isPro': true,
      ...
      },
      {
        ...
        'bio': 'P21 | Rising Local Legend. Jazz lover, wine snob, terrible dancer.',
      ...
      },
      {
        ...
        'bio': 'P21 | Pro explorer. Weekend market hunter. I live for the find. 🌿',
        'selectedVibes': ['Local Markets', 'Nature Spots', 'Budget Gems', 'Art & Design'],
        'karmaPoints': 210,
        'isSuperUser': false,
        'isAdmin': false,
        'isPro': true,
      ...
      },
      {
        ...
        'bio': 'P25 | Just arrived in Lisbon. Here to learn the city like a local.',
  ...
  static Future<void> _seedGems() async {
    ...
    final existing = await col.limit(1).get();
    if (existing.docs.isNotEmpty) { print('ℹ️  Gems already seeded.'); return; }

    final gems = [
      {
        'name': 'The Secret Rooftop at Bairro Alto',
        'description': 'A hidden rooftop bar tucked above a vinyl record shop. Only locals know the unmarked door. The sunset views over the Tagus are breathtaking.',
        'category': 'Rooftops',
        'vibe': 'Romantic',
        'rating': 4.8,
        'imageUrl': 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7139, 'longitude': -9.1434,
      ...
      },
      {
        ...
        'description': 'The real gems are the back stalls where local fishmongers sell grilled sardines at half the price of the tourist-facing Time Out Market.',
        'category': 'Street Food',
        'vibe': 'Local Favorite',
        'rating': 4.6,
        'imageUrl': 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7063, 'longitude': -9.1455,
      ...
      },
      {
        ...
        'description': 'A basement bookshop in Alfama with over 50,000 used books. The owner will personally recommend a book based on your mood.',
        'category': 'Cultural Sites',
        'vibe': 'Artsy',
        'rating': 4.9,
        'imageUrl': 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7141, 'longitude': -9.1329,
      ...
      },
      {
        ...
        'description': 'Street level it\'s a normal café, but descend the spiral stairs on Friday nights for live jazz in a candle-lit stone cellar.',
        ...
        'latitude': 38.7198, 'longitude': -9.1401,
      ...
      },
      {
        ...
        'description': 'A hidden trail behind the amphitheatre leads to a sunrise viewpoint that overlooks all of Lisbon. Unknown to tourists.',
        'category': 'Nature Spots',
        'vibe': 'Adventure',
        'rating': 4.5,
        'imageUrl': 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7378, 'longitude': -9.1354,
      ...
      },
      {
        ...
        'description': 'The smallest Fado house in Lisbon. Only 20 seats. No printed menu — the waiter tells you what\'s available. The owner performs every night.',
        'category': 'Hidden Dining',
        'vibe': 'Cultural',
        'rating': 4.9,
        'imageUrl': 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7101, 'longitude': -9.1467,
      ...
      },
      {
        ...
        'description': 'The inner courtyard hosts a smaller artisan market with local ceramics, vintage prints, and live music. Most tourists miss it entirely.',
        ...
        'latitude': 38.7037, 'longitude': -9.1771,
      ...
      },
      {
        ...
        'description': 'Below the elegant Palácio Chiado lies a 19th-century wine vault converted into an intimate tasting bar. Not listed anywhere online.',
        'category': 'Hidden Dining',
        'vibe': 'Luxury',
        'rating': 4.8,
        'imageUrl': 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7113, 'longitude': -9.1399,
      ...
      // ── Pending gems (in moderation queue) ───────────────────────────────
      {
        ...
        'description': 'An unofficial rooftop cinema that runs on Saturday nights in summer. BYO blanket. Films are always in original language.',
        'category': 'Rooftops',
        'vibe': 'Chill',
        'rating': 0.0,
        'imageUrl': 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7167, 'longitude': -9.1497,
      ...
      },
      {
        ...
        'description': 'A neighborhood restaurant that serves a 3-course lunch for €7 to locals only (tourists get the full menu). You need to ask in Portuguese.',
        'category': 'Hidden Dining',
        'vibe': 'Budget',
        'rating': 0.0,
        'imageUrl': 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=800&q=80',
        'latitude': 38.7215, 'longitude': -9.1388,
  ...
  static Future<void> _seedChats() async {
    ...
    final existing = await col.limit(1).get();
    if (existing.docs.isNotEmpty) { print('ℹ️  Chats already seeded.'); return; }
    ...
    await chat1Ref.set({
      ...
      'participantAvatars': {
        _youstinaId: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150',
        _manuelId: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150',
      },
    ...
    // Messages for chat 1
    final msgs1 = [
      {'senderId': _youstinaId, 'text': 'Hey! I saw your post about the Jazz Cellar. How do I find the entrance?', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_youstinaId]},
      {'senderId': _manuelId, 'text': 'Great question! It\'s a bit tricky for first-timers.', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_youstinaId, _manuelId]},
      {'senderId': _manuelId, 'text': 'The entrance is right behind the blue door on Rua Nova. Look for the vinyl records in the window.', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_manuelId]},
    ];
    ...
    await chat2Ref.set({
      ...
      'participantAvatars': {
        _youstinaId: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150',
        _chantalId: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150',
      },
    ...
    final msgs2 = [
      {'senderId': _youstinaId, 'text': 'Is the LX Factory market worth going to this Sunday?', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_youstinaId, _chantalId]},
      {'senderId': _chantalId, 'text': 'Absolutely! Go through the far-left gate for the hidden courtyard section.', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_youstinaId, _chantalId]},
      {'senderId': _chantalId, 'text': 'Definitely try the stuffed vine leaves from stall 14!', 'timestamp': FieldValue.serverTimestamp(), 'readBy': [_youstinaId, _chantalId]},
    ];
