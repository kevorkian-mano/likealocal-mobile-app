                ...
                return Stack(
                  children: [
                    Container(
                      ...
                      child: CustomImageView(
                        imagePath: provider.shareHiddenGemModel.selectedMediaPaths[index],
                        height: 100.h,
                        width: 100.h,
                        fit: BoxFit.cover,
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          // Note: Need a removeMedia method in provider, I'll assume it exists or use notifyListeners
                          provider.shareHiddenGemModel.selectedMediaPaths.removeAt(index);
                          provider.selectedImageFiles.removeAt(index);
