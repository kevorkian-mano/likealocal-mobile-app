    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(backgroundColor: Color(0xFFE8F2E9), child: Text(name[0], style: TextStyle(color: Color(0xFF1B3022)))),
              SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text('Regarding $gemName', style: TextStyle(fontSize: 10, color: Colors.grey)),
                  ],
                ),
              ),
          ...
          Text(
            question,
            style: TextStyleHelper.instance.body14MediumInter.copyWith(color: Color(0xFF4D6353), height: 1.4),
          ),
          SizedBox(height: 16),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              ...
              child: Text('Answer Question', style: TextStyle(color: Colors.white)),
            ),
          ),
        ],
      ),
